...
test("provider quota backoff applies for a full day without changing other retry classes", () => {
  ...
  assert.equal(providerRetrySeconds("FAILED", "PROVIDER_NETWORK_FAILURE", 3_600), 3_600);
});
