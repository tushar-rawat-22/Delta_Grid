...
- BTCUSDT and ETHUSDT are in shadow tracking.
- SOLUSDT remains excluded.
- Live trading remains blocked.
- Capital deployment remains blocked.

## Larger-Mission Roadmap

### Mission 58: Shadow Research Control Plane and Documentation Registry

One-command shadow research cycle plus documentation consistency checks.

### Mission 59: Multi-Strategy Research Factory

Add funding/basis, momentum, mean reversion, volatility regime, and relative strength research.

### Mission 60: Data Quality and Regime Intelligence Engine

Add freshness, outlier, liquidity, spread, volatility, and market danger classification.

### Mission 61: Shadow Portfolio Simulator

Move from isolated symbol tracking to portfolio-level shadow exposure and risk simulation.

### Mission 62: Research Promotion Board

Add investment-committee style promotion gates.

### Mission 63: Paper Trading Sandbox

Simulate orders, fills, fees, slippage, and paper PnL.

### Mission 64: Institutional Risk Control Layer

Add kill switches, exposure caps, circuit breakers, and audit trail.
