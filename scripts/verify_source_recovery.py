#!/usr/bin/env python3
"""Verify that the committed repository HEAD can be recovered from a Git bundle.

This is deliberately scoped to public source recovery. It does not inspect, copy,
or make claims about protected runtime data, credentials, private evidence stores,
